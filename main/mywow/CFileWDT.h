...
public:
	...
	IFileWDT* loadWDT( MPQFile* file, s32 mapid, bool simple );
};
...
public:
	...
	virtual bool loadFileSimple(MPQFile* file, s32 mapid);
	...
	virtual bool loadADT(STile* tile, bool simple = false);
