...
public:
	...
	//
	inline bool equals(const plane3d<T>, const T tolerance=(T)ROUNDING_ERROR_f32) const { return equals_(D, other.D, tolerance) && Normal.equals(other.Normal, tolerance); }
	...
	inline plane3d& operator=(const plane3d<T>& other)
	{
		_ASSERT(this != &other);
		if (this != &other)
		{
