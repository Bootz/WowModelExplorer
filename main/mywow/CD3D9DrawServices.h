...
public:
	...
	virtual void draw2DImage(ITexture* texture, vector2di destPos, f32 scale = 1.0f, bool alphaChannel = false, E_BLEND_FACTOR srcBlend=EBF_ONE, E_BLEND_FACTOR destBlend=EBF_ONE_MINUS_SRC_ALPHA);
...
private:
	...
	static const u32 MAX_3DLINE_BATCH_COUNT = 2048;
