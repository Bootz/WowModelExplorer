...
public:
	...
	inline bool equals(const dimension2d<T>& other, const T tolerance=(T)ROUNDING_ERROR_f32) const { return equals_(Width, other.Width, tolerance) && equals_(Height, other.Height, tolerance); }

	//
	inline bool operator==(const dimension2d<T>& other) const 
	{
		if ( this == &other ) return true;
		return memcmp(this, &other, sizeof(dimension2d<T>)) == 0;
	}
