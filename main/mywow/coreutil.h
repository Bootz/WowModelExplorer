...
inline s32 getLength_str16from8(const c8* str8)
{
	MultiByteToWideChar( CP_ACP, 0, str8, -1, NULL, 0 );
}
...
inline s32 getLength_str8from16(const c16* str16)
{
	return WideCharToMultiByte( CP_ACP, 0, str16, -1,
		NULL, 0, NULL, NULL );
}
...
inline s32 getLength_utf16from8(const c8* utf8)
{
	return MultiByteToWideChar( CP_UTF8, 0, utf8, -1, NULL, 0);
}
...
inline s32 getLength_utf8from16(const c16* utf16)
{
	return WideCharToMultiByte( CP_UTF8, 0, utf16, -1, NULL, 0, NULL, NULL);
}
...
inline void trim(const c8* str, c8* outstring, u32 size)
{
	...
	{
		strncpy_s(outstring, size, &str[left], right - left);
	}
}
