...
public:
	...
	inline triangle3d& operator=(const triangle3d<T>& other)
	{
		_ASSERT(this != &other);
		if (this != &other)
		{
	...
	inline bool equals(const triangle3d<T>& other, const T tolerance = (T)ROUNDING_ERROR_f32) const { return equals_(pointA, other.pointA) && equals_(pointB, other.pointB) && equals_(other.pointC); }

	inline bool operator==(const triangle3d<T>& other) const 
	{
		if ( this == &other ) return true;
		return memcmp(this, &other, sizeof(triangle3d<T>)) == 0;
	}
